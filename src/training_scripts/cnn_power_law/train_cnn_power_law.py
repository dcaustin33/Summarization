...
if __name__ == '__main__':
    ...
    #create the dataset
    dataset = PegasusCNNPowerLaw(model_name = args.model_name, max_length=args.max_length, split = 'train', divisor = args.divisor)
    val_dataset = PegasusCNNPowerLaw(model_name = args.model_name, max_length=args.max_length, split = 'validation', divisor = args.divisor)
