...
if __name__ == '__main__':
    ...
    #create the dataset
    dataset = XSumDatasetTfIdf(model_name = args.model_name, max_length=args.max_length, split = 'train')
    val_dataset = XSumDatasetTfIdf(model_name = args.model_name, max_length=args.max_length, split = 'validation')
